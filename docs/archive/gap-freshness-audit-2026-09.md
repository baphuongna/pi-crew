...
| **G25** | **OPEN** | ROADMAP Phase 3 items R3-1 (US-021 summary before/after), R3-2 (US-022 export md), R3-3 (review findings artifact), R3-4 (citations) — **all still backlog** | `grep -n "US-021\|US-022\|R3-3\|R3-4" docs/archive/ROADMAP-2026-Q3.md` | 4 backlog rows (:66-69) |
