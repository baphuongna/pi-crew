...
- [ ] **[DP-04](../specs/DP-04.md) fast-fix auto-suggest singleAgent**: goal ngắn (<N tokens) → default workflow trả 3 context setup (smoke 7.6–9k tokens cho goal trivial); thêm hint/auto-switch sang `singleAgent: true` hoặc chain 2 bước (engine đã hỗ trợ, chỉ là routing default)
...
| ID | Title | Lane | Priority | Status |
|----|-------|------|----------|--------|
| [SR-01](../specs/SR-01.md) | GL-1b part C — pre-try failures mark turn manifest failed | normal | P2 | planned |
